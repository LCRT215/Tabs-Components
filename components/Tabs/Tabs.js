class TabLink {
  constructor(element) {
    ...
    //   `.tabs-link[data-tab="${element.dataset.tab}"]`
    // );
  ...
  select() {
    ...
    links.forEach(link => {
      //const selected = document.querySelectorAll(".tabs-link-selected");
    ...
    //this.element = document.querySelector(".tabs-items-selected");
    // Call the select method on the item associated with this link
    this.tabItem.tabItemSelect();
  }
}
